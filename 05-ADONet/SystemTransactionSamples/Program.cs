...
namespace SystemTransactionSamples
{
    class Program
    {
        ...
        public static void ShowUsage()
        {
            ...
            Console.WriteLine("\t-c1\tCommittable Transactions");
            Console.WriteLine("\t-p1\tPromotable Transactions");
            Console.WriteLine("\t-d1\tDepdendent Transactions");
            Console.WriteLine("\t-a1\tAmbient Transactions");
            Console.WriteLine("\t-n1\tNested Transactions");
        }
        ...
        ////Platform has to support distribution transactions
